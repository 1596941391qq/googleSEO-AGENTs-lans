      ...
      <main className="max-w-7xl mx-auto px-6 py-8 space-y-8">
        ...
        {activeTab === 'sites' && (
          <div className="space-y-4">
            ...
            {showAddSite && (
              <Card className="border-zinc-800 bg-zinc-900/50 border-purple-500/50">
                <CardContent className="p-6 space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    <div className="space-y-2">
                      <label className="text-xs font-bold text-zinc-400">GitHub Token</label>
                      <Select
                        value={newSite.github_token_id}
                        onValueChange={(v) => setNewSite({ ...newSite, github_token_id: v })}
                      >
                        <SelectTrigger className="rounded-xl bg-zinc-800 border-zinc-700">
                    ...
                    <div className="space-y-2">
                      ...
                      <Select
                        ...
                        onValueChange={(v) => setNewSite({ ...newSite, platform: v })}
                      >
                        <SelectTrigger className="rounded-xl bg-zinc-800 border-zinc-700">
                          <SelectValue />
                        </SelectTrigger>
                    ...
                    {newSite.platform !== 'github_pages' && (
                      <div className="space-y-2">
                        <label className="text-xs font-bold text-zinc-400">Platform Token</label>
                        <Select
                          value={newSite.platform_token_id}
                          onValueChange={(v) => setNewSite({ ...newSite, platform_token_id: v })}
                        >
                          <SelectTrigger className="rounded-xl bg-zinc-800 border-zinc-700">
                    ...
                    <div className="space-y-2">
                      <label className="text-xs font-bold text-zinc-400">Content Type</label>
                      <Select
                        value={newSite.content_type}
                        onValueChange={(v) => setNewSite({ ...newSite, content_type: v })}
                      >
                        <SelectTrigger className="rounded-xl bg-zinc-800 border-zinc-700">
                          <SelectValue />
                        </SelectTrigger>
                    ...
                    <div className="space-y-2">
                      <label className="text-xs font-bold text-zinc-400">Site Name</label>
                      <Input
                        value={newSite.site_name}
                        onChange={(e) => setNewSite({ ...newSite, site_name: e.target.value })}
                        placeholder="e.g., ai-seo-docs"
                        className="rounded-xl bg-zinc-800 border-zinc-700"
                      />
                    </div>
                    <div className="space-y-2">
                      <label className="text-xs font-bold text-zinc-400">Repo Name</label>
                      <Input
                        value={newSite.repo_name}
                        onChange={(e) => setNewSite({ ...newSite, repo_name: e.target.value })}
                        placeholder="e.g., pseo-site-xxx"
                        className="rounded-xl bg-zinc-800 border-zinc-700"
                      />
                    </div>
                  </div>
                  <div className="flex justify-end gap-2">
                    ...
                    <Button
                      ...
                      disabled={!newSite.github_token_id || !newSite.site_name || !newSite.repo_name || 
                        (newSite.platform !== 'github_pages' && !newSite.platform_token_id)}
                      className="rounded-xl bg-purple-500 hover:bg-purple-600"
                    >
                      Add Site
                    </Button>
