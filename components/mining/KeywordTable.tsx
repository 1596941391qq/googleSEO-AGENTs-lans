              ...
              <React.Fragment key={item.id}>
                <tr
                  className={`transition-colors ${
                    isExpanded ? "bg-emerald-500/10" : "hover:bg-emerald-500/5"
                  }`}
                >
                  <td
                      ...
                      <div className="flex flex-col md:flex-row gap-6">
                        <div className="flex-1 space-y-4">
                          {(item.intentAssessment ||
                            ...
                            (() => {
                              ...
                              const isValidIntentAnalysis =
                                item.intentAnalysis &&
                                !hasErrorKeywords(item.intentAnalysis);
                          ...
                          {miningMode === "blue-ocean" &&
                            item.blueOceanScoreBreakdown &&
                            item.blueOceanScoreBreakdown.factors.length > 0 && (
                              <Card
                                className={cn(
                                  isDarkTheme
                                    ? "bg-black border-emerald-500/30"
                          ...
                          {(() => {
                            ...
                            const isValidReasoning =
                              item.reasoning &&
                              !hasErrorKeywords(item.reasoning);
                          ...
                          {item.serpResultCount === 0 ? (
                            <Card
                              className={cn(
                                ...
                                isDarkTheme ? "bg-amber-950/20" : "bg-amber-50"
                              )}
                            >
                              <CardContent className="p-4">
